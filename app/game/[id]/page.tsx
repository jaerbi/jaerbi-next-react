    ...
    <main className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="relative h-[400px] w-full">
        ...
        <div className="absolute bottom-10 left-10">
          ...
          <p className="mt-2 text-lg text-blue-400 uppercase tracking-widest font-semibold">
            {game.genre}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700">
            ...
            <p className="text-xl font-bold mt-1">
              {game.isFavorite ? '🌟 В списку обраних' : '🎮 В колекції'}
            </p>
          </div>
        ...
        <div className="mt-12">
          ...
          <p className="mt-6 text-gray-400 leading-relaxed text-lg">
            ...
            {game.title === 'Civilization VII' ? ' стратегіях' : ' виживанню'}, ця сторінка 
            ідеально підійде для опису твоїх проходжень або стрімів.
          </p>
        </div>
      </div>
    </main>
